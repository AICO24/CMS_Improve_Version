document.addEventListener('DOMContentLoaded', async function() {
    ...
    try {
        ...
        setText('sidebarUserRole', user.role ? user.role.charAt(0).toUpperCase() + user.role.slice(1) : 'Administrator');
        setText('userName', user.full_name || user.username || 'User');
        setText('userRole', user.role ? user.role.charAt(0).toUpperCase() + user.role.slice(1) : 'Administrator');
